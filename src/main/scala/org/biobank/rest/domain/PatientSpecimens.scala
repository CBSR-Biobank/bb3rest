...
case class PatientSpecimens(pnumber: String, study: String, storageCenters: List[CenterSpecimens])
...
object PatientSpecimensJsonProtocol extends DefaultJsonProtocol {
  ...
  implicit val patientSpecimensFormat = jsonFormat3(PatientSpecimens)
}
